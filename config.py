...
class Init(object):
    ...
    def __init__(self):
        ...
        # self.train_loss_dir     = "Training_loss" + self.nameModel      # always differents dir
        # self.train_loss_tag     = "Training_loss"                       # with same tag we cluster many plots
        # self.validation_dir     = "Validation_M1" + self.nameModel     
        # self.validation_tag     = "Validation"       
        # self.comment            = "M1: Original Model"
        ...
        self.framesBack         = 5
        self.resize             = False  #If true, uses trainStart - trainEnd to dataset
        self.trainStart         = 1
        self.trainEnd           = 500
